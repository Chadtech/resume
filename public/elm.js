...
var $author$project$Main$downloadPdf = _Platform_outgoingPort(
	'downloadPdf',
	function ($) {
...
var $author$project$Main$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(
			model,
			$author$project$Main$downloadPdf(_Utils_Tuple0));
	});
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Main$ClickeDownloadAsPdf = {$: 'ClickeDownloadAsPdf'};
...
var $author$project$Ext$Html$col = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$core$List$cons, $author$project$Style$col, styles))
				]),
			children);
	});
	...
	var viewFormatStyles = function () {
		...
		switch (_v1.$) {
			...
			default:
				var record = _v1.a;
				return _List_fromArray(
					[$author$project$Style$justifyCenter, $author$project$Style$itemsCenter]);
		}
	}();
	var bg = function () {
		...
		switch (_v0.$) {
			...
			case 'Pdf':
				return $author$project$Style$bgNightwood1;
			default:
				return $author$project$Style$bgNightwood1;
		}
	}();
	return $rtfeldman$elm_css$Css$Global$global(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Style$batch(viewFormatStyles),
...
var $author$project$Main$letterWidth = $rtfeldman$elm_css$Css$width(
	$rtfeldman$elm_css$Css$px(850));
var $rtfeldman$elm_css$Css$minHeight = $rtfeldman$elm_css$Css$prop1('min-height');
var $author$project$Style$minH0 = $rtfeldman$elm_css$Css$minHeight($rtfeldman$elm_css$Css$zero);
...
var $author$project$View$Button$primary = function (label) {
	return A2($author$project$View$Button$fromLabelAndVariant, label, $author$project$View$Button$Variant__Primary);
};
var $author$project$Main$ArduinoWearables = {$: 'ArduinoWearables'};
var $author$project$Main$HtmlGameHackathon = {$: 'HtmlGameHackathon'};
var $author$project$Main$allAwards = _List_fromArray(
	[$author$project$Main$ArduinoWearables, $author$project$Main$HtmlGameHackathon]);
...
var $author$project$Ext$Html$row = F2(
	function (styles, children) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Svg$Styled$Attributes$css(
					A2($elm$core$List$cons, $author$project$Style$row, styles))
				]),
			children);
	});
...
var $author$project$Ext$Html$s = $rtfeldman$elm_css$Html$Styled$text;
...
var $author$project$Main$awardView = function (award) {
	...
	var url = function () {
		if (award.$ === 'ArduinoWearables') {
			return 'https://imgur.com/QfDKg7P';
		} else {
			return 'https://hackphx.com/html5games_winter2012/';
		}
	}();
	var name = function () {
		if (award.$ === 'ArduinoWearables') {
			return 'Arduino Wearables';
		} else {
			return 'HTML5 Game';
		}
	}();
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[$author$project$Style$justifySpaceBetween, $author$project$Style$textGray4]),
				_List_fromArray(
					[
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						...
						_List_fromArray(
							[
								$author$project$Ext$Html$s('Winner of jury prize at '),
								A2(
								...
								$author$project$Ext$Html$s(' hackathon')
							])),
						$author$project$Ext$Html$s(year)
					]))
			]));
};
...
var $author$project$Main$education = A2(
	$author$project$Ext$Html$col,
	_List_fromArray(
		[$author$project$Style$textGray4, $author$project$Style$flex1]),
	_List_fromArray(
		[
			A2(
			$author$project$Ext$Html$row,
			...
			_List_fromArray(
				[
					$author$project$Ext$Html$s('education')
				])),
			A2(
			$author$project$Ext$Html$row,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$author$project$Ext$Html$s('Arizona State University')
				])),
			A2(
			$author$project$Ext$Html$row,
			_List_Nil,
			_List_fromArray(
				[
					$author$project$Ext$Html$s('Bachelor of Science in Economics')
				])),
			A2(
			$author$project$Ext$Html$row,
			_List_Nil,
			_List_fromArray(
				[
					$author$project$Ext$Html$s('Graduated 2013')
				]))
		]));
var $author$project$Main$volunteering = A2(
	$author$project$Ext$Html$col,
	_List_fromArray(
		[$author$project$Style$textGray4, $author$project$Style$flex1]),
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Ext$Html$s('volunteering')
				])),
			A2(
			$author$project$Ext$Html$row,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$author$project$Ext$Html$s('HeatSync Labs, 501(c)(3) non-profit')
				])),
			A2(
			$author$project$Ext$Html$row,
			_List_Nil,
			_List_fromArray(
				[
					$author$project$Ext$Html$s('Treasurer and active member')
				])),
			A2(
			$author$project$Ext$Html$row,
			_List_Nil,
			_List_fromArray(
				[
					$author$project$Ext$Html$s('2012 to 2014')
				]))
		]));
var $author$project$Main$educationAndVolunteering = A2(
	$author$project$Ext$Html$row,
	_List_fromArray(
		[$author$project$Style$g2]),
	_List_fromArray(
		[$author$project$Main$education, $author$project$Main$volunteering]));
var $author$project$Main$Chadtech = {$: 'Chadtech'};
var $author$project$Main$Humio = {$: 'Humio'};
var $author$project$Main$LocalMotors = {$: 'LocalMotors'};
var $author$project$Main$MackeyRMS = {$: 'MackeyRMS'};
var $author$project$Main$Shore = {$: 'Shore'};
var $author$project$Main$StructionSite = {$: 'StructionSite'};
var $author$project$Main$SuperFocus = {$: 'SuperFocus'};
var $author$project$Main$allJobs = _List_fromArray(
	[$author$project$Main$SuperFocus, $author$project$Main$StructionSite, $author$project$Main$MackeyRMS, $author$project$Main$Humio, $author$project$Main$Shore, $author$project$Main$LocalMotors, $author$project$Main$Chadtech]);
...
var $author$project$Main$descriptionColor = $author$project$Style$textGray5;
...
var $author$project$Style$fontItalic = $rtfeldman$elm_css$Css$fontStyle($rtfeldman$elm_css$Css$italic);
var $elm$core$Char$fromCode = _Char_fromCode;
var $rtfeldman$elm_css$Html$Styled$span = $rtfeldman$elm_css$Html$Styled$node('span');
var $author$project$Style$red1Str = '#F21D23';
var $author$project$Style$textRed1 = A2($rtfeldman$elm_css$Css$property, 'color', $author$project$Style$red1Str);
var $author$project$Main$techColor = $author$project$Style$textRed1;
...
var $author$project$Style$pre = $rtfeldman$elm_css$Css$whiteSpace($rtfeldman$elm_css$Css$pre);
var $author$project$Main$chadStearnsName = A2(
	$author$project$Ext$Html$col,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$fontFamilies(
			...
			A2($rtfeldman$elm_css$Css$property, '-webkit-font-smoothing', 'none'),
			$author$project$Style$pre
		]),
	_List_fromArray(
		[
			$author$project$Ext$Html$s('Chad Stearns')
		]));
var $author$project$Main$contactInfo = A2(
	$author$project$Ext$Html$col,
	_List_fromArray(
		[$author$project$Style$pre]),
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Ext$Html$s('phone: +1 480 450 6514')
				])),
			A2(
			$author$project$Ext$Html$row,
			_List_Nil,
			_List_fromArray(
				[
					$author$project$Ext$Html$s('email: chadtech0@gmail.com')
				]))
		]));
...
var $author$project$Main$resumeLinks = A2(
	$author$project$Ext$Html$col,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$href('https://www.github.com/chadtech/resume')
				]),
			_List_fromArray(
				[
					$author$project$Ext$Html$s('github.com/chadtech/resume')
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$author$project$Ext$Html$s('View this resume online')
				]))
		]));
var $author$project$Style$textGray0 = A2($rtfeldman$elm_css$Css$property, 'color', $author$project$Style$gray0Str);
var $author$project$Main$nameAndInfo = A2(
	$author$project$Ext$Html$row,
	_List_fromArray(
		[$author$project$Style$bgGray4, $author$project$Style$textGray0, $author$project$Style$p2, $author$project$Style$g4]),
	_List_fromArray(
		[$author$project$Main$chadStearnsName, $author$project$Main$resumeLinks, $author$project$Main$contactInfo]));
...
var $author$project$Main$projectView = function (project) {
	var url = function () {
		switch (project.$) {
			case 'Roc':
				return 'https://www.roc-lang.org/';
			case 'Radler':
				return 'https://github.com/Chadtech/Radler-ui';
			case 'CtPaint':
				return 'https://ctpaint.org/app';
			case 'ListExtra':
				return 'https://package.elm-lang.org/packages/elm-community/list-extra/latest/';
			case 'ElmCanvas':
				return 'https://github.com/Elm-Canvas/elm-canvas';
			case 'Himesama':
	...
	var projectName = function () {
		switch (project.$) {
			...
			case 'CtPaint':
				return 'CtPaint';
			case 'ListExtra':
				return 'elm-community/list-extra';
			case 'ElmCanvas':
				return 'elm-canvas';
			case 'Himesama':
				return 'Himesama';
	...
	var bulletPoints = function () {
		if (project.$ === 'Roc') {
			return _List_fromArray(
				['wrote a large majority of the Roc code formatter, which\n                    takes an abstract syntax tree,\n                    and converts it into textual code.', 'Wrote the first implementation of the\n                    core List functions compilation down to LLVM machine code.', 'Designed Roc\'s HashMaps.', 'Made the code that generates html files rendering Roc\n                    module documentation.']);
		} else {
			return _List_Nil;
		}
	}();
	var bulletPointsView = function () {
		if ($elm$core$List$isEmpty(bulletPoints)) {
			return $author$project$Ext$Html$s('');
		} else {
			var bulletPointView = function (bulletPoint) {
				return A2(
					$author$project$Ext$Html$row,
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Ext$Html$s(projectName)
							]))
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
...
var $author$project$Main$DesertCodeCamp = {$: 'DesertCodeCamp'};
var $author$project$Main$ElmEurope = {$: 'ElmEurope'};
var $author$project$Main$ElmOnlineMeetup = {$: 'ElmOnlineMeetup'};
var $author$project$Main$HashMaps = {$: 'HashMaps'};
var $author$project$Main$MunichFrontend = {$: 'MunichFrontend'};
var $author$project$Main$QueensJs = {$: 'QueensJs'};
var $author$project$Main$X29C3 = {$: 'X29C3'};
var $author$project$Main$allTalks = _List_fromArray(
	[$author$project$Main$HashMaps, $author$project$Main$ElmOnlineMeetup, $author$project$Main$ElmEurope, $author$project$Main$MunichFrontend, $author$project$Main$DesertCodeCamp, $author$project$Main$QueensJs, $author$project$Main$X29C3]);
var $author$project$Main$talkView = function (talk) {
	var year = function () {
		switch (talk.$) {
			case 'HashMaps':
				return '2022';
			case 'ElmOnlineMeetup':
				return '2021';
			case 'ElmEurope':
				return '2019';
			case 'MunichFrontend':
	...
	var title = function () {
		switch (talk.$) {
			case 'HashMaps':
				return 'Hash Maps';
			case 'ElmOnlineMeetup':
				return 'Analytics and Architecture in Elm';
			case 'ElmEurope':
				return 'What has excited me about Audio Synthesis Theory';
			case 'MunichFrontend':
				return 'Using Elm at Shore';
			case 'DesertCodeCamp':
				return 'How React works under the hood';
			case 'QueensJs':
				return 'CtPaint';
			default:
				return 'Lightning Talk on Audio Synthesizer';
		}
	}();
	var maybeUrl = function () {
		switch (talk.$) {
			case 'HashMaps':
				return $elm$core$Maybe$Just('https://www.youtube.com/watch?v=mJFoGR1w28Q');
			case 'ElmOnlineMeetup':
				return $elm$core$Maybe$Just('https://youtu.be/XlJuICG2kFU');
			case 'ElmEurope':
				return $elm$core$Maybe$Just('https://www.youtube.com/watch?v=RFCPAw5C5hQ');
			case 'MunichFrontend':
				return $elm$core$Maybe$Nothing;
			case 'DesertCodeCamp':
				return $elm$core$Maybe$Just('https://youtu.be/e6jzkoGeDEs');
			case 'QueensJs':
				return $elm$core$Maybe$Nothing;
			default:
				return $elm$core$Maybe$Nothing;
	...
	var titleView = function () {
		...
		if (maybeUrl.$ === 'Just') {
			...
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Ext$Html$s(withQuotes)
					]));
		} else {
			return $author$project$Ext$Html$s(withQuotes);
		}
	}();
	var maybeSummary = function () {
		switch (talk.$) {
			case 'HashMaps':
				return $elm$core$Maybe$Just('How Hashmaps work, as well as summarizing what\n                    I learned working on Roc\'s HashMap');
			case 'ElmOnlineMeetup':
				return $elm$core$Maybe$Just('In this talk I detail how I do frontend analytics\n                    in Elm, utilizing some tricks in Elm\'s type system to remind developers where they need to\n                    make changes.');
			case 'ElmEurope':
				return $elm$core$Maybe$Just('I demonstrate how to synthesize various instrument sounds in terms of the theories of\n                    additive synthesis and granular synthesis.');
			case 'MunichFrontend':
				return $elm$core$Maybe$Just('Shore\'s frontend lead engineer and I summarized what our experience has been\n                    with Elm.');
			case 'DesertCodeCamp':
				return $elm$core$Maybe$Just('My audience and I make React from scratch through incremental and small steps.');
			case 'QueensJs':
				return $elm$core$Maybe$Nothing;
			default:
				return $elm$core$Maybe$Nothing;
	...
	var summaryView = function () {
		if (maybeSummary.$ === 'Just') {
			...
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Ext$Html$s(summary)
					]));
		} else {
			return $author$project$Ext$Html$s('');
		}
	}();
	var maybeEvent = function () {
		switch (talk.$) {
			case 'HashMaps':
				return $elm$core$Maybe$Nothing;
			case 'ElmOnlineMeetup':
				return $elm$core$Maybe$Just('Elm Online Meetup');
			case 'ElmEurope':
				return $elm$core$Maybe$Just('Elm Europe');
			case 'MunichFrontend':
				return $elm$core$Maybe$Just('Munich Frontend');
			case 'DesertCodeCamp':
				return $elm$core$Maybe$Just('Desert Code Camp');
			case 'QueensJs':
				return $elm$core$Maybe$Just('QueensJs');
			default:
				return $elm$core$Maybe$Just('29C3');
		}
	}();
	var eventView = function () {
		if (maybeEvent.$ === 'Just') {
			var event = maybeEvent.a;
			return $author$project$Ext$Html$s(' at ' + event);
		} else {
			return $author$project$Ext$Html$s('');
		}
	}();
...
var $author$project$Main$talks = A2(
	$author$project$Ext$Html$col,
	_List_fromArray(
		[$author$project$Style$g2]),
	A2(
...
var $author$project$Main$thankYou = function (args) {
	var textColor = $author$project$Style$textGray5;
	var signature = _List_fromArray(
		[
			A2(
			$author$project$Ext$Html$col,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Ext$Html$s('Best,')
						])),
					A2(
					$author$project$Ext$Html$row,
					_List_Nil,
	...
	var messageView = function (message) {
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Ext$Html$s(message)
				]));
	};
	var greeting = _List_fromArray(
		[
			A2(
			$author$project$Ext$Html$row,
			_List_Nil,
			_List_fromArray(
				[
					$author$project$Ext$Html$s('Dear ' + (args.recipient + ','))
				]))
		]);
	return _List_fromArray(
		[
			...
			$author$project$Ext$Html$col,
			_List_fromArray(
				[$author$project$Style$border, $author$project$Style$bgGray1, $author$project$Style$outdent, $author$project$Style$w196, $author$project$Style$justifyCenter, $author$project$Style$p4, $author$project$Style$g4, textColor]),
				...
				case 'Web':
					return _List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Style$minH0,
									A2($rtfeldman$elm_css$Css$property, 'flex', '1 1 100%'),
									$author$project$Style$justifyCenter
								]),
							_List_fromArray(
								[
									A2(
							...
							_List_fromArray(
								[
									...
									$author$project$Ext$Html$row,
									_List_fromArray(
										[$author$project$Main$letterWidth, $author$project$Style$justifyEnd]),
									_List_fromArray(
										[
											$author$project$View$Button$toHtml(
											A2(
												$author$project$View$Button$onClick,
												$author$project$Main$ClickeDownloadAsPdf,
												$author$project$View$Button$primary('Download as PDF')))
										]))
								]))
						]);
				case 'Pdf':
...
var $author$project$Main$main = function () {
	...
	var update_ = F2(
		function (msg, state) {
			if (state.$ === 'State__Loaded') {
				var model = state.a;
				var _v4 = A2($author$project$Main$update, msg, model);
				var newModel = _v4.a;
				var cmd = _v4.b;
	...
	var init_ = function (json) {
		var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$flagsDecoder, json);
		if (_v0.$ === 'Ok') {
			var flags = _v0.a;
			var _v1 = $author$project$Main$init(flags);
			var model = _v1.a;
			var cmd = _v1.b;
			var state = $author$project$Main$State__Loaded(model);
			return _Utils_Tuple2(state, cmd);
		} else {
			var err = _v0.a;
			return _Utils_Tuple2(
				$author$project$Main$State__Failed(err),
				$elm$core$Platform$Cmd$none);
		}
	};
	return $elm$browser$Browser$document(
		{init: init_, subscriptions: subscriptions_, update: update_, view: view_});
}();
